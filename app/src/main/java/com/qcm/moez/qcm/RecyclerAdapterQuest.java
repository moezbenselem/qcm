...
public class RecyclerAdapterQuest extends RecyclerView.Adapter {
...
public RecyclerAdapterQuest(Context context, ArrayList<String> ids, ArrayList<String> qcmTitle, ArrayList<String> qcmDesc, ArrayList<String> idEns) {
